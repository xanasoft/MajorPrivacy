...
public:
	...
	void 					SetFilter(EFwDirections Dir, EEventStatus Action, ENetProtocols Protocol, int AreaFilter) { m_Dir = Dir; m_Action = Action; m_Protocol = Protocol; m_AreaFilter = AreaFilter;}
