...
#define FW_180x_BINARY_VERSION 0x021C // 170x
...
typedef struct _tag_FW_RULE
{
    ...
    //[string, range(1,10001)]
    PWCHAR wszGPOName;
    ULONG Reserved; // FW_OBJECT_CTRL_FLAG
...
} FW_MATCH_VALUE, *PFW_MATCH_VALUE;
...
typedef ULONG (NTAPI *P_FWOpenPolicyStore)(
...
typedef ULONG (NTAPI *P_FWClosePolicyStore)(
    _Inout_ PFW_POLICY_STORE_HANDLE phPolicyStore
    );

typedef ULONG (NTAPI *P_FWRestoreDefaults)(
    _In_ PWCHAR MachineOrGPO
    );

typedef ULONG (NTAPI *P_FWGetGlobalConfig)(
...
typedef ULONG (NTAPI *P_FWSetGlobalConfig)(
    _In_ USHORT wBinaryVersion, 
    _In_ PWCHAR wszMachineOrGPO, 
    _In_ FW_STORE_TYPE StoreType, 
    _In_ FW_GLOBAL_CONFIG configId, 
...
typedef ULONG (NTAPI *P_FWAddFirewallRule)(
    _In_ FW_POLICY_STORE_HANDLE hPolicyStore, 
    __inout PFW_RULE pRule
    );
...
FWSetFirewallRule(
    _In_ FW_POLICY_STORE_HANDLE hPolicyStore, 
    _In_ PFW_RULE pRule // PFW_RULE2_0
    );

typedef ULONG (NTAPI *P_FWSetFirewallRule)(
    _In_ FW_POLICY_STORE_HANDLE hPolicyStore, 
    _In_ PFW_RULE pRule // PFW_RULE2_0
    );
...
typedef ULONG (NTAPI *P_FWDeleteFirewallRule)(
    _In_ FW_POLICY_STORE_HANDLE hPolicyStore, 
    _In_ const __nullterminated PWCHAR wszRuleID
    );
...
typedef ULONG (NTAPI *P_FWDeleteAllFirewallRules)(
    _In_ FW_POLICY_STORE_HANDLE hPolicyStore
    );

typedef ULONG (NTAPI *P_FWEnumFirewallRules)(
    _In_ FW_POLICY_STORE_HANDLE hPolicyStore,
...
FWGetConfig(
    ...
    __inout ULONG* pdwBufSize
    );

typedef ULONG (NTAPI *P_FWGetConfig)(
    _In_ FW_POLICY_STORE_HANDLE hPolicyStore, 
    _In_ FW_PROFILE_CONFIG configId, 
    _In_ FW_PROFILE_TYPE Profile, 
    _In_ FW_CONFIG_FLAGS dwFlags, 
...
typedef ULONG (NTAPI *P_FWSetConfig)(
    _In_ FW_POLICY_STORE_HANDLE hPolicyStore, 
    _In_ FW_PROFILE_CONFIG configId, 
    _In_ FW_PROFILE_TYPE Profile, 
    _In_ FW_PROFILE_CONFIG_VALUE pConfig, 
...
typedef ULONG (NTAPI *P_FWAddConnectionSecurityRule)(
    _In_ FW_POLICY_STORE_HANDLE hPolicy, 
    _In_ PFW_CS_RULE2_0 pRule
    );
...
typedef ULONG (NTAPI *P_FWSetConnectionSecurityRule)(
    _In_ FW_POLICY_STORE_HANDLE hPolicy, 
    _In_ PFW_CS_RULE2_0 pRule
    );
...
typedef ULONG (NTAPI *P_FWDeleteConnectionSecurityRule)(
    _In_ FW_POLICY_STORE_HANDLE hPolicy, 
    _In_ __nullterminated PWCHAR pRuleId
    );
...
typedef ULONG (NTAPI *P_FWDeleteAllConnectionSecurityRules)(
    _In_ FW_POLICY_STORE_HANDLE hPolicy
    );
...
typedef ULONG (NTAPI *P_FWEnumConnectionSecurityRules)(
    _In_ FW_POLICY_STORE_HANDLE hPolicy, 
    _In_ FW_RULE_STATUS_CLASS dwFilteredByStatus, 
    _In_ FW_PROFILE_TYPE dwProfileFilter, 
    _In_ FW_ENUM_RULES_FLAGS wFlags, 
...
typedef ULONG (NTAPI *P_FWAddAuthenticationSet)(
    _In_ FW_POLICY_STORE_HANDLE hPolicy, 
    _In_ PFW_AUTH_SET pAuth
    );
...
typedef ULONG (NTAPI *P_FWSetAuthenticationSet)(
    _In_ FW_POLICY_STORE_HANDLE hPolicy, 
    _In_ PFW_AUTH_SET pAuth
    );
...
typedef ULONG (NTAPI *P_FWDeleteAuthenticationSet)(
    _In_ FW_POLICY_STORE_HANDLE hPolicy, 
    _In_ FW_IPSEC_PHASE IpSecPhase, 
    _In_ const PWCHAR wszSetId
    );
...
typedef ULONG (NTAPI *P_FWDeleteAllAuthenticationSets)(
    _In_ FW_POLICY_STORE_HANDLE hPolicy, 
    _In_ FW_IPSEC_PHASE IpSecPhase
    );
...
typedef ULONG (NTAPI *P_FWEnumAuthenticationSets)(
    _In_ FW_POLICY_STORE_HANDLE hPolicy, 
    _In_ FW_IPSEC_PHASE IpSecPhase, 
    _In_ FW_RULE_STATUS_CLASS dwFilteredByStatus, 
    _In_ FW_ENUM_RULES_FLAGS wFlags, 
...
typedef ULONG (NTAPI *P_FWAddCryptoSet)(
    _In_ FW_POLICY_STORE_HANDLE hPolicy, 
    _In_ PFW_CRYPTO_SET pCrypto
    );
...
typedef ULONG (NTAPI *P_FWSetCryptoSet)(
    _In_ FW_POLICY_STORE_HANDLE hPolicy, 
    _In_ PFW_CRYPTO_SET pCrypto
    );
...
typedef ULONG (NTAPI *P_FWDeleteCryptoSet)(
    _In_ FW_POLICY_STORE_HANDLE hPolicy, 
    _In_ FW_IPSEC_PHASE IpSecPhase,
    _In_ const __nullterminated PWCHAR wszSetId
    );
...
typedef ULONG (NTAPI *P_FWDeleteAllCryptoSets)(
    _In_ FW_POLICY_STORE_HANDLE hPolicy, 
    _In_ FW_IPSEC_PHASE IpSecPhase
    );
...
typedef ULONG (NTAPI *P_FWEnumCryptoSets)(
    _In_ FW_POLICY_STORE_HANDLE hPolicy, 
    _In_ FW_IPSEC_PHASE IpSecPhase, 
    _In_ FW_RULE_STATUS_CLASS dwFilteredByStatus, 
    _In_ FW_ENUM_RULES_FLAGS wFlags, 
...
typedef ULONG (NTAPI *P_FWEnumPhase1SAs)(
    _In_ FW_POLICY_STORE_HANDLE hPolicy, 
    _In_ PFW_ENDPOINTS pEndpoints, 
    __out PULONG pdwNumSAs, 
    __out_ecount(pdwNumSAs) PFW_PHASE1_SA_DETAILS* ppSAs
...
typedef ULONG (NTAPI *P_FWEnumPhase2SAs)(
    _In_ FW_POLICY_STORE_HANDLE hPolicy, 
    _In_ PFW_ENDPOINTS pEndpoints, 
    __out PULONG pdwNumSAs, 
    __out_ecount(pdwNumSAs) PFW_PHASE2_SA_DETAILS* ppSAs
...
typedef ULONG (NTAPI *P_FWDeletePhase1SAs)(
    _In_ FW_POLICY_STORE_HANDLE hPolicy, 
    _In_ PFW_ENDPOINTS pEndpoints
    );
...
typedef ULONG (NTAPI *P_FWDeletePhase2SAs)(
    _In_ FW_POLICY_STORE_HANDLE hPolicy, 
    _In_ PFW_ENDPOINTS pEndpoints
    );
...
typedef ULONG (WINAPI *P_FWEnumProducts)(
    _In_ FW_POLICY_STORE_HANDLE hPolicy, 
...
typedef ULONG (WINAPI *P_FWFreeProducts)(
...
typedef ULONG (WINAPI *P_FWAddMainModeRule)(
    _In_ FW_POLICY_STORE_HANDLE hPolicy, 
...
typedef ULONG (WINAPI *P_FWSetMainModeRule)(
    _In_ FW_POLICY_STORE_HANDLE hPolicy, 
    _In_ PFW_MM_RULE pMMRule, 
    __out FW_RULE_STATUS* pStatus
    );
...
typedef ULONG (WINAPI *P_FWDeleteMainModeRule)(
    _In_ FW_POLICY_STORE_HANDLE hPolicy, 
    _In_ LPWSTR pRuleId
    );
...
typedef ULONG (WINAPI *P_FWDeleteAllMainModeRules)(
    _In_ FW_POLICY_STORE_HANDLE hPolicy
    );
...
typedef ULONG (WINAPI *P_FWEnumMainModeRules)(
    _In_ FW_POLICY_STORE_HANDLE hPolicy,
    _In_ FW_RULE_STATUS_CLASS dwFilteredByStatus,
    _In_ FW_PROFILE_TYPE dwProfileFilter,
    _In_ FW_ENUM_RULES_FLAGS wFlags,
...
typedef ULONG (WINAPI *P_FWQueryFirewallRules)(
    _In_ FW_POLICY_STORE_HANDLE hPolicy, 
...
typedef ULONG (WINAPI *P_FWQueryConnectionSecurityRules)(
    _In_ FW_POLICY_STORE_HANDLE hPolicy, 
    _In_ PFW_QUERY pQuery, 
    _In_ FW_ENUM_RULES_FLAGS wFlags, 
    __out PULONG pdwNumRules, 
...
typedef ULONG (WINAPI *P_FWQueryMainModeRules)(
    _In_ FW_POLICY_STORE_HANDLE hPolicy, 
    _In_ PFW_QUERY pQuery, 
    _In_ FW_ENUM_RULES_FLAGS wFlags, 
    __out PULONG pdwNumRules, 
...
typedef ULONG (WINAPI *P_FWQueryAuthenticationSets)(
    _In_ FW_POLICY_STORE_HANDLE hPolicy, 
    _In_ FW_IPSEC_PHASE IPsecPhase, 
    _In_ PFW_QUERY pQuery,
    _In_ FW_ENUM_RULES_FLAGS wFlags, 
...
typedef ULONG (WINAPI *P_FWQueryCryptoSets)(
    _In_ FW_POLICY_STORE_HANDLE hPolicy, 
    _In_ FW_IPSEC_PHASE IPsecPhase, 
    _In_ PFW_QUERY pQuery,
    _In_ FW_ENUM_RULES_FLAGS wFlags, 
...
typedef ULONG (WINAPI *P_FWEnumNetworks)(
    _In_ FW_POLICY_STORE_HANDLE hPolicy, 
...
typedef ULONG (NTAPI *P_FWEnumAdapters)(
    _In_ FW_POLICY_STORE_HANDLE hPolicy, 
    __out PULONG pdwNumAdapters, 
    __out_ecount(pdwNumAdapters) PFW_ADAPTER* ppAdapters
    );
...
typedef ULONG (NTAPI *P_FWFreeAdapters)(
    _In_ PFW_ADAPTER pAdapters
    );

typedef ULONG (NTAPI *P_FWFreeFirewallRules)(
...
typedef ULONG (NTAPI *P_FWFreeNetworks)(
    _In_ PFW_NETWORK pNetworks
    );

typedef ULONG (NTAPI *P_FWStatusMessageFromStatusCode)(
...
typedef ULONG (NTAPI *P_FWVerifyFirewallRule)(
    _In_ USHORT wBinaryVersion, 
    __inout PFW_RULE pRule
    );
...
typedef ULONG (NTAPI *P_FWExportPolicy)(
    _In_ CONST __nullterminated PWCHAR wszMachineOrGPO,
    _In_ BOOLEAN fGPO, 
    _In_ CONST __nullterminated PWCHAR wszFilePath, 
    __out PBOOLEAN fSomeInfoLost
...
typedef ULONG (NTAPI *P_FWRestoreGPODefaults)(
    _In_ CONST __nullterminated PWCHAR wszGPOPath
    );
...
typedef ULONG (NTAPI *P_FwIsGroupPolicyEnforced)(
    _In_ CONST __nullterminated PWCHAR wszMachine, 
    _In_ ULONG Profiles, 
    __out PBOOLEAN dwEnforced
    );
...
typedef ULONG (NTAPI *P_FWChangeNotificationCreate)(
    _In_ HANDLE hEvent, //WaitHandle
    __out PHANDLE hNewNotifyObject
    );
...
typedef ULONG (NTAPI *P_FWChangeNotificationDestroy)(
    __out PHANDLE hNotifyObject
    );
...
//typedef ULONG (WINAPI *P_FWChangeTransactionalState(IntPtr hPolicy, FW_TRANSACTIONAL_STATE TransactionState);
//typedef ULONG (WINAPI *P_FWRevertTransaction(IntPtr hPolicy);
...
//#include <netfw.h> // FirewallAPI.lib
...
typedef DWORD (WINAPI *P_NetworkIsolationFreeAppContainers)(
    _In_ PINET_FIREWALL_APP_CONTAINER pPublicAppCs 
    );

typedef DWORD (WINAPI *P_NetworkIsolationEnumAppContainers)(
    _In_  DWORD Flags,
