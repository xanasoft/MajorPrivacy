...
#pragma prefast(suppress : 6011) // buffer is not null
	...
	switch (EventId)
	{
		case WIN_LOG_EVENT_FW_ADDED:	Event.Type = SWinFwGuardEvent::EType::Added; break;
		case WIN_LOG_EVENT_FW_REMOVED:	Event.Type = SWinFwGuardEvent::EType::Removed; break;
		case WIN_LOG_EVENT_FW_CHANGED:	Event.Type = SWinFwGuardEvent::EType::Changed; break;
	}
