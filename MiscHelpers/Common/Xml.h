...
public:
	...
	static QVariant Parse(const QString& String, bool*pOK = NULL, bool bLazy = false);

	static void Serialize(const QVariant& Variant, QFile* pFile);
	static QVariant Parse(QFile* pFile, bool*pOK = NULL);
...
protected:
	...
	static QVariant Parse(QXmlStreamReader &xml, bool*pOK = NULL, bool bLazy = false);
